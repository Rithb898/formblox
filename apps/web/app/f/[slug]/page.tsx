    ...
    <PageShell>
      <div className="flex flex-col items-center gap-4 py-16 text-center">
        <div className="flex size-14 items-center justify-center rounded-full border border-white/[0.07] bg-[#141414]">
          <svg className="size-7 text-[#6B6B6B]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <div className="space-y-1">
          <p className="text-base font-semibold text-[#F2F2F2]">This form isn&apos;t live yet</p>
          <p className="text-sm text-[#6B6B6B]">Check back later — the owner hasn&apos;t published it.</p>
        </div>
      </div>
    </PageShell>
  );
